...
export default function AdminWorkspace({ route }) {
            ...
            <Card className="creai-card rounded-3xl p-6">
              ...
              {categoryBarData.length ? (
                ...
                <div className="mt-6 flex flex-wrap gap-2">
                  ...
                  {!categories.length ? <Text>No categories yet.</Text> : null}
                </div>
              )}
            </Card>
          </div>
  ...
  return (
    <div className="creai-workspace-shell h-screen overflow-hidden bg-mist-100 p-4 dark:bg-ink-950 lg:p-5">
      <div className="w-full overflow-hidden rounded-[2rem] border border-mist-200/80 bg-white shadow-soft dark:border-ink-700 dark:bg-ink-950 dark:shadow-soft-dark">
        ...
        <main className="creai-scrollbar min-w-0 flex-1 overflow-y-auto p-6 lg:h-[calc(100vh-2.5rem)] lg:p-8">
          <div className="mx-auto flex w-full max-w-[1040px] flex-col gap-6 pb-8">
            <Flex
              flexDirection="col"
