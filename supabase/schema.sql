...
create table if not exists public.apps (
  ...
  mobile_technologies text[] not null default '{}',
  platforms jsonb not null default '{"ios":{"enabled":false,"status":"draft","url":""},"android":{"enabled":false,"status":"draft","url":""},"web":{"enabled":false,"status":"draft","url":""}}'::jsonb,
